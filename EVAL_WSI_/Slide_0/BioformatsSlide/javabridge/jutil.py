...
from javabridge import _javabridge
...
def make_future_task(runnable_or_callable, 
    ...
    >>> callable = javabridge.run_script(""" new java.util.concurrent.Callable() {  call: function() { return 2+2; }};""")
