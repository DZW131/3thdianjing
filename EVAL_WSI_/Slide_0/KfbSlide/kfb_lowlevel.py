...
from EVAL_WSI_1GPU.Slide_0.BioformatsSlide.javabridge.jutil import unicode

os.environ["PATH"] = os.path.abspath( os.path.dirname(__file__) ) + ";" + os.environ["PATH"]

_lib = cdll.LoadLibrary(r"D:\msqtry\region_level_train\EVAL_WSI_1GPU\liblibkfbslide.so")
