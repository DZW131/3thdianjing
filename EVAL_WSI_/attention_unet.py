...
class Resnet_Unet(nn.Module):
    ...
    def __init__(self, in_channel,out_class,BN_enable=True, resnet_pretrain=False,backbone='resnet34'):
        super().__init__()
        self.BN_enable = BN_enable
        # encoder部分
        ...
        self.firstconv = resnet.conv1#nn.Conv2d(in_channels=in_channel, out_channels=64, kernel_size=7, stride=2, padding=3, bias=False)
