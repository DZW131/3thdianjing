...
piclke_root_dir='/media/deepin/DeepInformatic_dataset/lihansheng/HER2/Exp_v2/shangzhong0120'
...
def main(result_save_dir):
    ...
    columns = ['slide name', 'predict', '微弱的不完整膜阳性肿瘤细胞', '弱-中等的完整细胞膜阳性肿瘤细胞', '阴性肿瘤细胞', '纤维细胞', '淋巴细胞',
               '难以区分的非肿瘤细胞', '组织细胞',
