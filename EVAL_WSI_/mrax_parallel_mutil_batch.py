...
from Core.papSmear.multi_cls_cell_seg_batch import cal_ki67_np
...
def processing(comm, comm_rank, comm_size, slide_path, weight_path):
    ...
    if not os.path.exists(
        ...
        if comm_rank == 0:
            ...
            net = detnet(input_channels=3, num_classes=10)
...
if __name__ == "__main__":
    ...
    test_dir = '/media/kd/50e6b0a1-557f-451b-a4bc-34464a164acf/数据集/PDL1_Positive_cell_seg_detection/PDL1200切片/Slide/DEMO'
    comm = MPI.COMM_WORLD
    ...
    weight_path = "/media/kd/50e6b0a1-557f-451b-a4bc-34464a164acf/research/UNET/S5_NET_PDL1_CELL_DETECTION/4_Point_detection/PDL1_Parallel_KYX_06302021/Model/nested_unet_select_dataset_512_for_wsi_12calss_with_out_xuanwu/weights_epoch_252_1.45360054330128.pth"
